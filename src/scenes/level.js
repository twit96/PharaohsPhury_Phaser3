...
export default class levelScene extends Phaser.Scene {
  ...
  create() {
    ...
    const bossTileset = map.addTilesetImage("sand_tiles", "sandTiles");

    if (this.levelNum == 0) {
      const bgLayer = map.createStaticLayer("Below Player", bossTileset, 0, 0);
      const invisLayer = map.createStaticLayer("Invisible", bossTileset, 0, 0);
      this.worldLayer = map.createStaticLayer("World", bossTileset, 0, 0);
      console.log('[create boss layer]');
    }
    ...
    if (this.levelNum == 0) {
      this.aboveLayer = map.createStaticLayer("Above Player", sandTiles, 0, 0);
    }
